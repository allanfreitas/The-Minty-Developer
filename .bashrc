...
alias compass:sass="compass create compass-sass -r bootstrap-sass --using bootstrap"
alias compass:foundation="compass create compass-foundation -r zurb-foundation --using foundation"
